...
<section class="section">
    ...
    <div class="section-header-breadcrumb">
        <a href="{{ url('strategic_direction') }}"><span class="badge badge-success">Strategic direction</span></a>
    </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="card">
            <form method="POST" action="{{ url('strategic_direction/store') }}">
            @csrf
            <div class="card-header">
                <h4>Form input strategic direction</h4>
            </div>
            <div class="card-body">
                ...
                <input name="strategic_direction" value="{{ old('strategic_direction') }}" type="text" class="form-control" required="">
                </div>
                <div class="form-group">
                <label>Weight</label>
