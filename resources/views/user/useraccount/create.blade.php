...
<section class="section">
    ...
    <div class="section-header-breadcrumb">
        <a href="{{ url('user/account') }}"><span class="badge badge-success">User account Home</span></a>
    </div>
    </div>
    ...
    <form method="POST" action="{{ url('user/useraccount/store') }}">
    <div class="row">
        @csrf
        ...
        <div class="card">   
            ...
            <div class="card-body">
                ...
                <option value="1" {{ old('is_internal') == '1' ? "selected" :""}}>Yes</option>
                <option value="0" {{ old('is_internal') == '0' ? "selected" :""}}>No</option>
                </select>
                </div>
                ...
                <option value="{{ $row['id'] }}" {{ old('person_id') == $row['id'] ? "selected" :""}}>{{ $row['first_name'] }} {{ $row['middle_name'] }} {{ $row['last_name'] }}</option>
                @endforeach
                </select>
                </div>
                ...
                <input name="password" value="{{ old('password') }}" type="password" class="form-control" required="">
                </div>

                <div class="form-group">
                <label>Salt</label>
                <input name="salt" value="{{ old('salt') }}" type="text" class="form-control">
                </div>
