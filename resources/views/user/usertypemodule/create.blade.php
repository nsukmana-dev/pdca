...
<section class="section">
    ...
    <div class="row">
        ...
        <div class="card">
            <form method="POST" action="{{ url('user/usertypemodule/store') }}">
            @csrf
            <div class="card-header">
                <h4>Form Input User Type Module</h4>
            </div>
            <div class="card-body">
                ...
                <option value="{{ $row['id'] }}">{{ $row['user_type_name'] }}</option>
                @endforeach
                </select>
                </div>
