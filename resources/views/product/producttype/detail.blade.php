    ...
    <div class="row gutters-sm">
        <div class="col-md-4 mb-3">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <p class="text-muted font-size-sm">{{ $product->product_status }} - {{ $product->currency_name }}</p>
        ...
        <div class="col-md-8">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-9">
                    {{ $product->currency_code }} - {{ $product->currency_name }}
                </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="row">
                <div class="col-sm-3">
                    <h6 class="mb-0">Purchase age</h6>
                </div>
                <div class="col-sm-9">
                    {{ $product->purchase_age }}
                </div>
                </div>
                <hr>
                <div class="row">
                <div class="col-sm-3">
                    <h6 class="mb-0">Is featured</h6>
                </div>
                <div class="col-sm-9">
                ...
                <div class="row">
                <div class="col-sm-3">
                    <h6 class="mb-0">Product file name</h6>
                </div>
                <div class="col-sm-9">
                ...
                <div class="row">
                <div class="col-sm-12">
                    <a class="btn btn-info " href="{{ url('product/product/edit/'.$product->id.'') }}">Edit</a>
                </div>
                </div>
            </div>
            </div>
